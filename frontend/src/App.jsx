...
function App() {
  ...
  if (!session) {
    return (
      <div style={{ 
        ...
        <h1 style={{ color: '#38bdf8', fontSize: '3rem', marginBottom: '10px' }}>
          Estudio SaaS 🧠
        </h1>
        <p style={{ color: '#94a3b8', fontSize: '1.2rem', marginBottom: '40px' }}>
          Tu plataforma de Active Recall para la UADE
        </p>
        <button 
        ...
        <div style={{ display: 'grid', gap: '20px' }}>
          {examenes.length === 0 ? (
            <p style={{ textAlign: 'center', color: '#94a3b8' }}>
              No tenés exámenes guardados aún.
            </p>
          ) : (
            examenes.map(ex => (
              <div 
              ...
              >
                <div>
                  ...
                  <p style={{ color: '#38bdf8', margin: '4px 0 0 0', fontWeight: '600' }}>
                    {ex.materia}
                  </p>
                </div>
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          ...
          <p style={{ fontSize: '1.5rem', color: '#94a3b8' }}>
            Tu rendimiento promedio: {' '}
            <span style={{ 
              color: notaFinal >= 4 ? '#38bdf8' : '#ef4444', 
              fontWeight: 'bold' 
            }}>
          ...
          {historialSesion.map((item, i) => (
            <div 
              ...
              style={{ 
                ...
                padding: '25px', 
                borderRadius: '15px', 
                borderLeft: `6px solid ${item.nota >= 7 ? '#22c55e' : item.nota >= 4 ? '#eab308' : '#ef4444'}` 
              }}
            >
              <h4 style={{ margin: '0 0 10px 0', color: '#38bdf8' }}>
                {i+1}. {item.pregunta}
              </h4>
  ...
  return (
    <div style={{ 
      ...
      >
        <ChevronLeft size={20} /> Abandonar repaso
      </button>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <p style={{ 
          ...
          PREGUNTA {indicePregunta + 1} DE {examenSeleccionado.contenido_json.preguntas.length}
        </p>
        <h2 style={{ 
          fontSize: '1.8rem', 
          lineHeight: '1.4', 
        ...
        {preguntaActual.opciones ? (
            ...
            {preguntaActual.opciones.map((opt, i) => (
              <button 
                ...
                onClick={() => {
                  ...
                  manejarRespuesta(
                    esCorrecta ? 10 : 0, 
                    esCorrecta ? "¡Correcto!" : `Incorrecto. La respuesta era: ${preguntaActual.respuesta_correcta}`, 
                    opt
                  );
                }}
                style={{ 
          ...
          // MODO PROFUNDO - Respuesta Abierta
          <div>
            {!resultadoEvaluacion ? (
              <>
                <textarea 
                ...
                <button 
                  ...
                  disabled={evaluando || !respuestaEscrita.trim()} 
                  style={{ 
                    width: '100%', 
                    padding: '18px', 
                    borderRadius: '12px', 
                    backgroundColor: (evaluando || !respuestaEscrita.trim()) ? '#334155' : '#22c55e', 
                    color: 'white', 
                    fontWeight: 'bold', 
                    fontSize: '1.1rem', 
                    cursor: (evaluando || !respuestaEscrita.trim()) ? 'not-allowed' : 'pointer', 
                    border: 'none',
                    opacity: (evaluando || !respuestaEscrita.trim()) ? 0.6 : 1,
                    transition: 'all 0.2s'
                  }}
                >
              ...
              <div style={{ 
                ...
                padding: '30px', 
                borderRadius: '20px', 
                border: `2px solid ${resultadoEvaluacion.nota >= 7 ? '#22c55e' : resultadoEvaluacion.nota >= 4 ? '#eab308' : '#ef4444'}` 
              }}>
                {/* Calificación */}
                <div style={{ 
                  marginBottom: '25px', 
                  ...
                  <div style={{ 
                    fontSize: '3rem', 
                    fontWeight: 'bold',
                    color: resultadoEvaluacion.nota >= 7 ? '#22c55e' : resultadoEvaluacion.nota >= 4 ? '#eab308' : '#ef4444'
                  }}>
                    {resultadoEvaluacion.nota}/10
                  </div>
                </div>
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <p style={{ 
                    ...
                    {resultadoEvaluacion.feedback}
                  </p>
                </div>

                {/* Respuesta Ideal */}
                {resultadoEvaluacion.respuesta_ideal && 
                 resultadoEvaluacion.respuesta_ideal !== "No disponible en esta evaluación" && (
                  <div style={{ marginBottom: '25px' }}>
                    ...
                    <p style={{
                      ...
                      💡 Usa esta respuesta como referencia para mejorar tus próximas respuestas
                    </p>
                  </div>
                )}
